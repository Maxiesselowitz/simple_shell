...
/**
 * add_node - it adds a node to te start of the list
 *
 * @head: the address of pointer to the head node
 *
 * @str: the str of the field of node
 *
 * @num: node index used ny history
 *
...
list_t *add_node_end(list_t **head, const char *str, int num)
{
	...
	_memset((void *)new_node, 0, sizef(list_t))
		new_node->num = num;
...
/**
 * print_list_str - it prints only the str element
 *
...
/**
 * delete_node_at_index - it deletes node at the index
 *
 * @head: address of pointerto first node
 *
 * @index: index of node to delete
 *
 * Return: 0 if it fails OR 1 on success
 */
